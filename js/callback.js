...
//   const copyUsers = [...users].sort((bigestBalance, smallestBalance) => 
//   bigestBalance.balance - smallestBalance.balance);
//   return copyUsers;
// };
...
//   const copyUsersArray = [...users].sort((biggestFriends, smallestFriends) => smallestFriends.friends.length - biggestFriends.friends.length);
...
//   const copyUsersArray = [...users].sort((firstNameLetter, secondNameLetter) => firstNameLetter.name.localeCompare(secondNameLetter.name));
...
// .sort((firstLetterName,secondLettername) => firstLetterName.localeCompare(secondLettername));
...
//   const names = 
//   [...users].sort((biggest, smallest) => biggest.friends.length - smallest.friends.length)
//   .map(user => user.name);
...
//   const names = users.flatMap(user => user.friends)
//   .filter((friend, index, array) => array.indexOf(friend) === index)
//   .sort((firstLetter, secondLetter) => firstLetter.localeCompare(secondLetter));
//   return names;
// };
