...
//     let longestWord = '';
//     for (let i = 0; i < convertedString.length; i +=1) {
//         if (longestWord.length < convertedString[i].length) {
//             longestWord = convertedString[i];
//         }      
//     }
//     return longestWord;
...
// // создать переменную с новым массивом
//     const modifiedArray = [];
...
// // если в массиве numbers есть числа больше value запушить их в новый массив
// // вернуть новый массив с новыми числами
// }
...
//     for (let i = 0; i < array1.length; i += 1) {
//         const comparedItens = array2.includes(array1[i]);
